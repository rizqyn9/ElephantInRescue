...
//public class AttributesFoldOut : PropertyAttribute
//{
...
//    public AttributesFoldOut(string name, bool foldEverything = false)
//    {
...
//#if UNITY_EDITOR
//public class AttributesFoldOutHandler
//{
...
//    public AttributesFoldOutHandler(UnityEngine.Object target, SerializedObject serializedObject)
//    {
//        _target = target;
...
//        AttributesFoldOut prevFold = default;
...
//            var fold = Attribute.GetCustomAttribute(objectFields[i], typeof(AttributesFoldOutHandler)) as FoldAttributesFoldOutoutAttribute;
//            CacheFoldProp c;
//            if (fold == null)
//            {
...
//        public AttributesFoldOut Attribute;
